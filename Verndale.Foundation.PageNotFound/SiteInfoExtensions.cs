...
namespace Verndale.Foundation.PageNotFound
{
	/// <summary>
	...
	public static class SiteInfoExtensions
	{
		...
		public static ID GetPageNotFoundID(this SiteInfo site)
		{
			...
			Log.Warn($"Verndale.Foundation.PageNotFound SiteInfoExtensions: No value for notFoundPageID on site {site.Name}", typeof(SiteInfoExtensions));
			return null;
		}
	}
}
